      ...
      <div className="relative mx-auto max-w-7xl px-4 py-24 sm:px-6 sm:py-32 lg:px-8 lg:py-40">
        <div className="max-w-3xl">
          ...
          <h1 className="mb-6 text-4xl font-bold leading-tight tracking-tight text-white sm:text-5xl lg:text-6xl">
            Votre santé,{' '}<span className="text-primary-400">notre priorité</span>
          </h1>
          <p className="mb-8 max-w-2xl text-lg leading-relaxed text-gray-300 sm:text-xl">
            Consultez des médecins qualifiés, commandez vos médicaments et gérez votre santé depuis une seule plateforme — sécurisée, moderne et accessible.
          </p>
        ...
        <div className="mt-16 grid gap-4 sm:grid-cols-3 sm:gap-6">
          {[
            ...
            <div key={item.title} className="rounded-xl bg-white/5 p-5 backdrop-blur-sm border border-white/10">
